...
public class SensorConsumer{
    ...
    private static long getOffsetFromDB(TopicPartition p){
        ...
        try{
                ...
                Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/kafka","xxxxxx","xxxxxxxxx");
                //System.out.println("db con open");
                String sql = "select offset from tss_offsets where topic_name='" + p.topic() + "' and partitions=" + p.partition();
                ...
                System.out.println("Exception in getOffsetFromDB : " +e);
            }
        return offset;
    }

    private static void saveAndCommit(KafkaConsumer<String, String> c, ConsumerRecord<String, String> r){
        System.out.println("Topic=" + r.topic() + " Partitions=" + r.partition() + " Offset=" + r.offset() + " Key=" + r.key() + " Value=" + r.value());
        try{
            Class.forName("com.mysql.jdbc.Driver");
            Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/kafka","xxxxxxx","xxxxxxxx");
            //System.out.println("db con open");
            ...
            System.out.println("Exception in saveAndCommit : "+e);
        }
